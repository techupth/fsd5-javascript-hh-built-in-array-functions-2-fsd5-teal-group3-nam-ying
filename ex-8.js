...
const totalPaidByLocation = bills.reduce((acc, totalValue) => {
  if (acc[totalValue.location] === undefined) {
    acc[totalValue.location] = 0;
  }
  acc[totalValue.location] += totalValue.total;
  return acc;
}, {});
